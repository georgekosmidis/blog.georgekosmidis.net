...
It started as my ```nullable reference types playground``` because they are now enabled by default (for C# 10 project templates), but it evolved as my **static blog builder**! So yes, this repo is used to automatically build my very own blog that you can find at https://blog.georgekosmidis.net :)
